...
namespace Parquet.Thrift
{
   ...
   /// 
   /// </summary>
   partial class DictionaryPageHeader : TBase
   {
      ...
      public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
      {
         ...
         try
         {
            var tmp75 = new TStruct("DictionaryPageHeader");
            await oprot.WriteStructBeginAsync(tmp75, cancellationToken);
            var tmp76 = new TField();
            tmp76.Name = "num_values";
            tmp76.Type = TType.I32;
            tmp76.ID = 1;
      ...
      {
         var tmp77 = new StringBuilder("DictionaryPageHeader(");
         tmp77.Append(", Num_values: ");
         Num_values.ToString(tmp77);
         tmp77.Append(", Encoding: ");
         Encoding.ToString(tmp77);
         if (__isset.is_sorted)
         {
            tmp77.Append(", Is_sorted: ");
            Is_sorted.ToString(tmp77);
         }
         tmp77.Append(')');
