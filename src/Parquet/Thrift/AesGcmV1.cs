   ...
   partial class AesGcmV1 : TBase
   {
      ...
      public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
      {
         ...
         try
         {
            ...
            {
               tmp215.Name = "supply_aad_prefix";
               tmp215.Type = TType.Bool;
               tmp215.ID = 3;
               await oprot.WriteFieldBeginAsync(tmp215, cancellationToken);
      ...
      {
         if (!(that is AesGcmV1 other)) return false;
      ...
      {
         var tmp216 = new StringBuilder("AesGcmV1(");
         int tmp217 = 0;
         if ((Aad_prefix != null) && __isset.aad_prefix)
         {
            if (0 < tmp217++) { tmp216.Append(", "); }
            tmp216.Append("Aad_prefix: ");
            Aad_prefix.ToString(tmp216);
         }
         if ((Aad_file_unique != null) && __isset.aad_file_unique)
         {
            if (0 < tmp217++) { tmp216.Append(", "); }
            tmp216.Append("Aad_file_unique: ");
            Aad_file_unique.ToString(tmp216);
         }
         if (__isset.supply_aad_prefix)
         {
            if (0 < tmp217++) { tmp216.Append(", "); }
            tmp216.Append("Supply_aad_prefix: ");
            Supply_aad_prefix.ToString(tmp216);
         }
         tmp216.Append(')');
